...
---
Copied verbatim from https://github.com/cathrynlavery/diagram-design (repo root) — reproduced here because only the `skills/diagram-design/` subfolder was vendored into this collection, not the full upstream repo.
